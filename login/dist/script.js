  ...
  document.querySelectorAll('.form-group').forEach(group => {
    ...
    if (inputEl && label) {
      ...
      if (inputEl.id === 'researcher-id') {
        inputEl.setAttribute('placeholder', 'format: @example.com');
...
function activateLockout() {
  ...
  if (!document.querySelector('.lockout-message')) {
    ...
    lockoutMsg.innerHTML = '<span class="alert-prefix">ALERT:</span> SECURITY PROTOCOL ACTIVATED<span>System locked. Unauthorized access detected.</span><span class="small-text">SENDING DETAILS</span>';
